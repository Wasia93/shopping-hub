...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white-900 px-4 md:px-8 py-4 flex items-center justify-between font-sans" data-aos="fade-down" data-aos-duration="3000">
      <div className="flex items-center space-x-4">
        ...
        <div className="font-bold text-xl tracking-wide">Shopping Hub</div>
      </div>
      <ul
        className={`${
          isMenuOpen
